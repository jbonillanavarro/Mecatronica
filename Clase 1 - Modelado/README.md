...
El condensador se modela considerando su capacitancia $C$ y una resistencia de fuga $R_1$ en paralelo, que representa la pérdida interna de tensión en circuito abierto.
